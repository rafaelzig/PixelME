 ...
 */
public class ColorBitPreference extends DialogPreference
{
	...
	public ColorBitPreference(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}

	public ColorBitPreference(Context context, AttributeSet attrs, int defStyleAttr)
	{
