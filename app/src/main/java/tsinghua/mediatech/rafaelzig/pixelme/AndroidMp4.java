...
public class AndroidMp4
{
	...
	public void encodeImage(File jpeg, int macroblockSize, int colorBits) throws IOException
	{
		Bitmap read = ImageUtils.decodeAndTransform(jpeg, macroblockSize, colorBits);
